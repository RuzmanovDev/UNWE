...
namespace MassiveDynamic
{
    public partial class ListPriceByGivenName : Form
    {
        ...
        private DataSet GetPriceByGivenName(string customerName)
        {
            ...
            string command = String.Format("select UnitPrice from Products where ProductName='{0}'", ProductNameDropDown.Text);
        ...
        private void dataGridPriceByGivenName_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
