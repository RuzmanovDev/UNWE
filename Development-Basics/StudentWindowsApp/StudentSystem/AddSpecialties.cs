namespace StudentSystem
{
    ...
    public partial class AddSpecialties : Form
    {
        public AddSpecialties()
        {
            InitializeComponent();
        }
        ...
        private void AddSpecialtyButton_Click(object sender, EventArgs e)
        {
            ...
            string command = "insert into EducationForm (EducForm) values ('" + NameOfSpecialtyTextBox.Text + "')";
